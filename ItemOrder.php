    ...
    <div class = "container">
        ...
        <form action = "#" method="post" name="myform" enctype="multipart/form-data">
            ...
            <div class = "form-submit-btn">
                <input type ="submit" name = "try" value = "Save" onclick="calculate()"> 
            </div>
            <a href="index.html">Go Back</a>
            <a href="generate.php">Download Pdf</a>
        </div>
        ...
        <table border="3" cellpadding="8" cellspacing="8" class="tbl">
            <tr>
                <center><td>Name</td></center>
                <center><td>Contact</td></center>
                <center><td>Email</td></center>
                <center><td>Address</td></center>
                <center><td>Item Type</td></center>
                <center><td>Item Name</td></center>
       ...
       ?></td>
        ...
        <center><input type="submit" name="submit" value="Place Order"></form></center>
    </body>
</html>
...
$connString = $db->getConnstring();
        ...
        $count++;
        echo "$count:$name[$key], $contact[$key], $email[$key], $address[$key], $fix[$key], $optionlist[$key], $quantity[$key], $wpn[$key]";
        $add = mysqli_query($connString, "insert into orderform (Name, Contact, Email, Address, ItemType, ItemName, Quantity, TotalBill) 
     values ('$name[$key]', '$contact[$key]', '$email[$key]', '$address[$key]', '$fix[$key]', '$optionlist[$key]', '$quantity[$key]', '$wpn[$key]')") or die(mysqli_error($conn));
